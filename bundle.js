...
/***/ function(module, exports, __webpack_require__) {
	...
	var hideAdminConsole = function hideAdminConsole() {
	...
	var displaySpoileryAnchors = function displaySpoileryAnchors(response) {
	  $('#spoilery-posts-anchors').text('');
	  var posts = response.spoilery_posts;
	  var anchorTemplate = __webpack_require__(13);
	  $('#spoilery-posts-anchors').append(anchorTemplate({
	    posts: posts
	  }));
	};

	var displayNoSpoilerAnchors = function displayNoSpoilerAnchors(response) {
	  $('#no-spoilers-posts-anchors').text('');
	  var posts = response.no_spoilers_posts;
	  var anchorTemplate = __webpack_require__(13);
	...
	//
	var displaySpoileryPosts = function displaySpoileryPosts(response) {
	  var saveAnchors = $('#spoilery-posts-anchors');
	  $('#spoilery-posts').text('');
	  $('#spoilery-posts').append(saveAnchors);
	  var posts = response.spoilery_posts;
	  var spoileryPostTemplate = __webpack_require__(33);
	  $('#spoilery-posts').append(spoileryPostTemplate({
	    posts: posts
	  }));
	};

	var displayNoSpoilersPosts = function displayNoSpoilersPosts(response) {
	  var saveAnchors = $('#no-spoilers-posts-anchors');
	  $('#no-spoilers-posts').text('');
	  $('#no-spoilers-posts').append(saveAnchors);
	  var posts = response.no_spoilers_posts;
	  var noSpoilersPostTemplate = __webpack_require__(34);
	  $('#no-spoilers-posts').append(noSpoilersPostTemplate({
	    posts: posts
	  }));
	};

	var displayGameList = function displayGameList(response) {
	  var games = response.games;
	  var gameListTemplate = __webpack_require__(35);
	...
	var refreshHandlebars = function refreshHandlebars() {
	  getSpoileryPosts();
	  getNoSpoilersPosts();
	  getGames();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"table-of-contents\"><a href=\"#"
	    ...
	    + "\">"
	    + alias1(container.lambda(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</a></div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"post-title\"><a name=\""
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "\"><h3>"
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "</h3></a></div>\n<div class=\"game-name\"><b><big>"
	    + alias4(alias5(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</big></b><div>\n<div class=\"developed-by\">Developed by: "
	    + alias4(alias5(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.developer : stack1), depth0))
	    + "</div>\n<div class=\"platforms\">Platforms: "
	    + alias4(alias5(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.platforms : stack1), depth0))
	    + "</div>\n<div class=\"spoiler-warning\">WARNING: You are in the plot analysis zone, meaning that anything worth spoiling CAN and WILL BE spoiled. Check out the \"Spoiler Free Zone\" for posts written for new players.</div>\n<div class=\"post-content\">"
	    ...
	    + "</div>\n<button type=\"button\" class=\"btn btn-primary btn-sm sp-modal-trigger admin-console\" data-toggle=\"modal\" data-target=\"#SpoileryModal\" value=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n  Edit\n</button>\n<button class=\"sp-delete-buttons btn btn-primary btn-sm admin-console\" id=\"del-sp"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "-g"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"post-title\"><a name=\""
	    ...
	    + "</div>\n<div class=\"post-content\">"
	    + ((stack1 = ((helper = (helper = helpers.content || (depth0 != null ? depth0.content : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"content","hash":{},"data":data}) : helper))) != null ? stack1 : "")
	    + "</div>\n<button type=\"button\" class=\"btn btn-primary btn-sm ns-modal-trigger admin-console\" href=\"#noSpoilersModal\" value=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n  Edit\n</button>\n<button class=\"ns-delete-buttons btn btn-primary btn-sm admin-console\" id=\"del-np"
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "-g"
	    + alias4(alias5(((stack1 = (depth0 != null ? depth0.game : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" value=\""
